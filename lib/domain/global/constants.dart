...
const String passwordRegex = r"^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,}$";

const String suportedImageExtensions = r'^\.(jpg|png|jpeg)';

const String displayNameRegex =
    r'^[a-zA-Z0-9\s\-\.àáâäãåèéêëìíîïòóôöõøùúûüÿýñçčšžÀÁÂÄÃÅÈÉÊËÌÍÎÏÒÓÔÖÕØÙÚÛÜŸÝÑßÇŒÆČŠŽ∂ð&,]+$';
const int maxDisplayNameLength = 55;
